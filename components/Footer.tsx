...
const COPY: Record<string, { tagline: string; services: string; routes: string; contact: string; ocean: string; air: string; trucking: string; customs: string; door: string; destinations: string[] }> = {
  en: { tagline: "Your trusted logistics partner from Vietnam to the world.", services: "Services", routes: "Popular Routes", contact: "Contact", ocean: "Ocean Freight", air: "Air Freight", trucking: "Drayage & Trucking", customs: "Customs Clearance", door: "Door to Door", destinations: ["Italy", "Spain", "Indonesia", "Taiwan"] },
