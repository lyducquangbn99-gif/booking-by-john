...
export default async function OceanRoutes() {
  ...
  return (
    <section id="routes" className="mx-auto max-w-7xl px-5 py-16 lg:px-8 lg:py-20">
      ...
      <div className="mt-8 text-center"><Link href="/routes" className="inline-flex rounded-md border border-ocean-blue px-6 py-3 font-black text-ocean-blue hover:bg-white">{copy.allRoutes}</Link></div>
    </section>
  );
}
