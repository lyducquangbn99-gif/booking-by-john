            ...
            return (
              <article key={title} className="rounded-lg border border-border-subtle bg-white p-6 shadow-sm">
                ...
                {([0, 1, 2, 4, 5].includes(index)) && (
                  <Link href={index === 0 ? "/services/freight-forwarder-vietnam" : index === 1 ? "/services/air-freight-vietnam" : index === 2 ? "/services/inland-trucking-vietnam" : index === 4 ? "/services/customs-clearance-vietnam" : "/services/door-to-door-shipping-vietnam"} className="mt-4 inline-flex font-bold text-ocean-blue underline underline-offset-4">
                    {copy.details}
                  </Link>
                )}
              </article>
