...
const COPY: Record<string, { label: string; heading: string; details: string; items: Array<[string, string]> }> = {
  en: { label: "Services", heading: "Freight services built around clear communication", details: "View service details", items: [
    ["Ocean Freight", "FCL and LCL shipping with practical routing and rate guidance."], ["Air Freight", "Urgent cargo support when speed matters more than ocean transit."], ["Drayage & Trucking", "Port pickup, inland delivery, and coordinated container movement."], ["Warehousing", "Storage and handling support before export or final delivery."], ["Customs Clearance", "Documentation and clearance coordination to reduce delays."], ["Door to Door", "End-to-end logistics from Vietnam origin to overseas consignee."],
  ]},
