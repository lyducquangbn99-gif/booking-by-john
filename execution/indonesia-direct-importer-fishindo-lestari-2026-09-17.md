# Indonesia direct-importer qualification — PT Fishindo Lestari Bersama
...
## Route-matched first-touch angle
Lead with relevance, not a generic rate sheet: Vietnam-origin seafood logistics support into Indonesia, document-readiness resource, then ask whether they currently have any Vietnam-origin FCL/LCL/air requirement where an additional origin-side option would be useful.

Suggested handoff:
1. PI/LS/PIB Indonesia import-document readiness guide.
2. Vietnam → Indonesia commercial route page.
3. Request current pickup/destination, commodity/HS, temperature requirement, mode, weight/CBM/container, cargo-ready date and Incoterm before quoting.

## Decision-maker evidence
- Kartika Kumala Sari: public professional profiles identify CEO/Commissioner responsibilities and seafood marketing/export experience.
- Muslim Muslim: public LinkedIn result identifies Direktur Utama at PT Fishindo Lestari Bersama.
