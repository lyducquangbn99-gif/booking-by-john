    ...
    <main className="min-h-screen bg-bg-primary text-text-primary">
      ...
      <section className="bg-[#0B1F3A] px-5 py-16 text-white lg:px-8 lg:py-24">
        <div className="mx-auto max-w-6xl">
          ...
          <Link href="/?origin=Vietnam&destination=Indonesia&source=vietnam-to-indonesia-hero#request" className="mt-9 inline-flex rounded-md bg-accent-orange px-6 py-3 font-black text-white">{copy.quote}</Link>
        </div>
      </section>
      ...
      <section className="mx-auto grid max-w-6xl gap-10 px-5 py-14 lg:grid-cols-2 lg:px-8 lg:py-20">
        <div>
          ...
          <Link href="/?origin=Vietnam&destination=Indonesia&source=vietnam-to-indonesia-details#request" className="mt-6 inline-flex rounded-md bg-accent-orange px-6 py-3 font-black text-white">{copy.quote}</Link>
        </div>
      ...
      <section className="bg-[#0B1F3A] px-5 py-14 text-center text-white lg:px-8">
        ...
        <Link href="/?origin=Vietnam&destination=Indonesia&source=vietnam-to-indonesia-final#request" className="mt-8 inline-flex rounded-md bg-accent-orange px-6 py-3 font-black text-white">{copy.quote}</Link>
      </section>
      <Footer />
    </main>
  );
